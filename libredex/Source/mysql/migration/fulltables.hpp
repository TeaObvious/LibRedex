...
CREATE TABLE IF NOT EXISTS `player` (
  ...
  CONSTRAINT `fk_player_clan1`
    ...
    REFERENCES `clan` (`uuid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_player_world1`
    FOREIGN KEY (`targetworld_uuid`)
    REFERENCES `world` (`uuid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Add cross foreign key
-- -----------------------------------------------------
ALTER TABLE `clan`
ADD FOREIGN KEY (`founder_uuid`)
    REFERENCES `player` (`uuid`);

-- -----------------------------------------------------
-- Table `persistent_variables`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `charactershareables`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `charactershareables` (
  `uuid` BINARY(16) NOT NULL,
  `classname` VARCHAR(45) NOT NULL,
  `hitpoints` TEXT NULL,
  `variables` TEXT NULL,
  ...
  CONSTRAINT `fk_charactershareables_death_persistant_variables`
    ...
    REFERENCES `persistent_variables` (`uuid`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `character` (
  ...
  CONSTRAINT `fk_character_charactershareables`
    ...
    REFERENCES `charactershareables` (`uuid`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `world_is_linked_to_world`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `world_is_linked_to_world` (
...
-- Table `killinfo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `killinfo` (
  `uuid` BINARY(16) NOT NULL,
...
-- -----------------------------------------------------
-- Table `world_has_objects`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `world_has_objects` (
...
-- -----------------------------------------------------
-- Table `player_on_world_has_character`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `player_on_world_has_character` (
...
-- -----------------------------------------------------
-- Table `player_on_world_has_persistent_variables`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `player_on_world_has_persistent_variables` (
  `player_uuid` BINARY(16) NOT NULL,
  `world_uuid` BINARY(16) NOT NULL,
  `persistent_variables_uuid` BINARY(16) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `clan_member` (
  ...
  INDEX `fk_clan_members_player1_idx` (`player_uuid` ASC),
  CONSTRAINT `fk_clan_members_clan1`
    FOREIGN KEY (`clan_uuid`)
    REFERENCES `clan` (`uuid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_clan_members_player1`
    FOREIGN KEY (`player_uuid`)
    REFERENCES `player` (`uuid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `world_has_persistent_variables`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `world_has_persistent_variables` (
  `world_uuid` BINARY(16) NOT NULL,
  `persistent_variables_uuid` BINARY(16) NOT NULL,
...
-- -----------------------------------------------------
-- Table `clan_has_persistent_variables`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `clan_has_persistent_variables` (
  `clan_uuid` BINARY(16) NOT NULL,
  `persistent_variables_uuid` BINARY(16) NOT NULL,
...
-- View `killinfoview`
-- -----------------------------------------------------
CREATE  OR REPLACE VIEW `killinfoview` AS
SELECT `victim`.`lastnick` as `victim`, `attacker`.`lastnick` as `attacker`, `killinfo`.`date`, `killinfo`.`type`, `killinfo`.`weapon`, `killinfo`.`distance`
FROM `player_on_world_has_character`
INNER JOIN `player` AS `victim`
ON `player_on_world_has_character`.`player_uuid` = `victim`.`uuid`
INNER JOIN `killinfo`
ON `player_on_world_has_character`.`killinfo_uuid` = `killinfo`.`uuid`
LEFT JOIN `player` AS `attacker`
ON `killinfo`.`attacker_uuid` = `attacker`.`uuid`
WHERE `player_on_world_has_character`.`killinfo_uuid` IS NOT NULL;
